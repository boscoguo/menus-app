...
describe("<Longin />", () => {
  ...
  it("should have no hints when email and password fields are both correct", () => {
    ...
    async () => {
      const errorMessageNode = await screen.findAllByTestId(
        "login-email-error"
      );
  ...
  it("should hint users when password too long or too short", () => {
    ...
    userEvent.type(
      passwordInput,
      "test@163.comjoijoijoijoijoijoijoijoijoijoijoijoijoijoijoijewfjwoiejfoiewjhfoiwejfoiwejfoiu3298yurf89eut489shiuyhui4oejfoiwej"
    );
    async () => {
